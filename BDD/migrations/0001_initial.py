# Generated by Django 2.0 on 2018-02-17 14:21
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('id_appareil', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='BDD.Appareil')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('droit', models.CharField(max_length=42)),
                ('id_fichiers', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='BDD.Fichier')),
                ('id_user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
